<?php if (!defined('IN_PHPBB')) exit; $this->_tpldata['DEFINE']['.']['UCP_PM'] = TRUE; $this->_tpl_include('ucp_header.html'); $this->_tpl_include('ucp_pm_message_header.html'); if ($this->_rootref['S_DISPLAY_HISTORY'] && ( $this->_rootref['U_VIEW_PREVIOUS_HISTORY'] || $this->_rootref['U_VIEW_NEXT_HISTORY'] )) {  ?>
...
<div id="post-<?php echo (isset($this->_rootref['MESSAGE_ID'])) ? $this->_rootref['MESSAGE_ID'] : ''; ?>" class="post pm<?php if ($this->_rootref['S_POST_UNAPPROVED'] || $this->_rootref['S_POST_REPORTED']) {  ?> reported<?php } if ($this->_rootref['S_ONLINE']) {  ?> online<?php } ?>">
	...
	<dl class="postprofile" id="profile<?php echo (isset($this->_rootref['MESSAGE_ID'])) ? $this->_rootref['MESSAGE_ID'] : ''; ?>">
		...
		<?php if ($this->_rootref['RANK_TITLE'] || $this->_rootref['RANK_IMG']) {  ?><dd class="poster-rank"><?php if ($this->_rootref['RANK_IMG']) {  echo (isset($this->_rootref['RANK_IMG'])) ? $this->_rootref['RANK_IMG'] : ''; } else { echo (isset($this->_rootref['RANK_TITLE'])) ? $this->_rootref['RANK_TITLE'] : ''; } ?></dd><?php } if ($this->_rootref['S_ONLINE'] && $this->_rootref['ONLINE_IMG']) {  ?><dd class="poster-online"><?php echo (isset($this->_rootref['ONLINE_IMG'])) ? $this->_rootref['ONLINE_IMG'] : ''; ?></dd><?php } if ($this->_rootref['AUTHOR_AVATAR']) {  ?>
